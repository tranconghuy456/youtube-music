...
const Shelf = () => {
  return (
    <div className="shelf">
      <header className="flex justify-between">
        <div className="info flex items-center space-x-3 text-xl">
          <div className="picture">
            <img className="w-[56px] h-[56px]" src={picture} alt="" />
          </div>
      ...
      <div className="carsousel-container flex space-x-6 mt-[3rem]">
        <Carousel />
        <Carousel />
        <Carousel />
        <Carousel />
...
const Carousel = () => {
  return (
    <div className="carousel cursor-pointer flex flex-col items-center justify-center text-center w-[160px] h-[160px] bg-[rgba(0,0,0,0.2)] space-y-2 hover:outline outline-1 outline-[#525252]">
